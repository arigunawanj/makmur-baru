                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('category.update', $item->id) }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="namaKategori" value="{{ $item->namaKategori }}" class="form-control"
                                                                id="">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="">Deskripsi Kategori</label>
                                                            <textarea name="descKategori" class="form-control" id="" cols="30" rows="10">{{ $item->descKategori }}</textarea>
                                                        </div>
                                                </div>
